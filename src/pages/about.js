...
const AboutPage = ({ data }) => (
  ...
  <div className="col-xs-12 col-sm-8">
      ...
      <p className="coa-about__body">When the City of Austin joined the Open Government Partnership’s Subnational Pilot Program in December 2016, we made a commitment to build and test a project tracking tool as part of our participation. In short, we committed to up the City of Austin’s game in transparency, civic participation, accountability, and technology innovation. <a href="https://www.opengovpartnership.org/about/about-ogp" target="_blank" class="link--external">Learn more about the Open Government Partnership</a>
      </p>
